...
import "./KagıtTasimaAdmin.css";

const KagitTasimaAdmin = () => {
  ...
  useEffect(() => {
    ...
    const localStorageData = localStorage.getItem("localstorage_kagittaşıma");
    if (localStorageData) {
      ...
      setFormData((prevData) => ({
        ...
        tasinacak_kagit: parsedData.tasinacak_kagit,
        tasima_bedeli: parsedData.tasima_bedeli.toString(),
        tasima_bedeli_turu: parsedData.tasima_bedeli_turu,
...
export default KagitTasimaAdmin;
