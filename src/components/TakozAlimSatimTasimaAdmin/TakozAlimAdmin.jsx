...
const TakozAlimAdmin = () => {
  ...
  useEffect(() => {
    ...
    const localStorageData = localStorage.getItem("localstorage_takozalim");
    if (localStorageData) {
      ...
      setFormData((prevData) => ({
        ...
        alis_kuru: parsedData.alis_kuru.toString(),
