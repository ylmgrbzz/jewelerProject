...
import "./VirmanUpdateAdmin.css";
import { Link } from "react-router-dom";
import api from "../../services/api";
import { useNavigate } from "react-router-dom";
const VirmanUpdateAdmin = () => {
  ...
  useEffect(() => {
    ...
    const localStorageData = localStorage.getItem("localstorage_virman");
    if (localStorageData) {
      const parsedData = JSON.parse(localStorageData);
      console.log("parsedData", parsedData);
      setFormData((prevData) => ({
        ...prevData,
        alici_kasa: parsedData.alici_kasa.id,
        gonderen_kasa: parsedData.gonderen_kasa.name,
        transfer_cinsi: parsedData.transfer_cinsi,
        transfer_tutari: parsedData.transfer_tutari.toString(),
      ...
      >
        ...
        <div class="form-group">
          ...
          >
            ...
            {kasaList.map((kasa) => (
              <option style={{ color: "black" }} key={kasa.id} value={kasa.id}>
                {kasa.name}
              </option>
            ))}
          </select>
...
export default VirmanUpdateAdmin;
